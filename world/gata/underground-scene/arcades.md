...
<figure><img src="../../../.gitbook/assets/arcades-323.png" alt="" width="563"><figcaption><p>Crowds weave through an arcade mall.</p></figcaption></figure>

Increasingly popular for all ages, and particularly among the youth of [Greater Atla](../politics/greater-atla.md), arcades are thriving hubs where patrons experience the latest and most sophisticated entertainment technologies and media. Arcades feature a mix of classic games, modern interactive media, immersive [virtual constructs](../../science-and-tech/constructs.md#virtual-constructs), and popular gambling staples, and they host live entertainment such as live music, comedy, theatre, and tournaments.

As with all [legal enterprise](../enterprise/), they are restricted to ["blue" tech](../../science-and-tech/tech-regulation.md#class-3-blue)—including legacy technology that has been deemed safe by [the AIC](../institutions/atlan-information-control-aic.md), as well as other technologies permitted within their jurisdiction's [paradigm](../politics/paradigms.md).



<div><figure><img src="../../../.gitbook/assets/arcades-333.png" alt=""><figcaption></figcaption></figure> <figure><img src="../../../.gitbook/assets/arcades-922.png" alt=""><figcaption></figcaption></figure></div>

Most arcades are eclectic entertainment malls that appeal to all ages, and benefit from a family-friendly atmosphere during daytime hours. However, arcades are even better known for their late-night scene, which is much more raucous and lively, particularly when a big performance is headlining on their main stage.

Over the table, arcades offer a wide selection of vendors and restaurants where patrons can purchase food, alcoholic and non-alcoholic beverages, as well as various legal [Manna](../../nature-and-climate/the-manna-flower.md) extracts. However, with a little savvy, it's often possible to acquire a range of [substances](recreational-drugs.md) that aren't strictly legal.

### Underground Arcades

<figure><img src="../../../.gitbook/assets/arcade-345.png" alt="" width="563"><figcaption></figcaption></figure>

In contrast to regulated arcades, those in Gray Zones and across the Free Territories offer a much wider range of unfiltered entertainment, featuring both legal and [illegal tech](../../science-and-tech/tech-regulation.md) and media, and few restrictions on the use and sale of [recreational substances](recreational-drugs.md).

These arcades tend to be operated by, or under the protection of, [local gangs](../criminal-element/gangs.md) or [criminal syndicates](../criminal-element/syndicates.md), who are incentivized to maintain a relatively safe environment for GATA citizens venturing into the zone, bringing [money](../politics/money.md), [keys](../politics/keys.md), and other opportunities into the local economy.

They are hubs for black market trade, often housing bazaars teeming with booths and kiosks selling everything from illicit [psychotech](../../science-and-tech/psychotech.md) and legacy weapons, to [Old World](../../history/the-old-world.md) media and other [scavenged contraband](../criminal-element/scavengers.md). These Gray Zone arcades are also known to share a roof with unlicensed [pleasure houses](pleasure-houses.md), some more discreet than others.

<div><figure><img src="../../../.gitbook/assets/arcade-433.png" alt="" width="563"><figcaption></figcaption></figure> <figure><img src="../../../.gitbook/assets/arcades-933.png" alt="" width="563"><figcaption></figcaption></figure></div>
