...
* **Link** — neural/skin interface. _Verb_: to link (connect), _Adj_: linked (active).
...
* **Sync** — can have multiple meanings, depending on usage:
  * (1) noun - a shared mental state; a _“sync”_ is subjective and dynamic; the shared subjective state of two or more participants.
