...
Bitcoin is the most prominent legacy currency remaining from the Old World. Primarily used as a store of value and a hedge against volatility similar to how gold was used historically. Due to the prevalence of asteroid mining and techniques that allow the synthesis of many rare and exotic materials, precious metals like gold are no longer suitable for that purpose.
