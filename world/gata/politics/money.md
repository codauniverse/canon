...
The System's economic policies, which can be modulated by [Quorum governance](governance.md#structure), are automatically enforced on transactions. Economic incentives, disincentives, taxes, and mandatory reporting requirements are built into System commerce.

While the System promises stability and efficiency, this comes at the cost of its automatic filtering of suspicious transactions. As a side effect, this [hard-coded](../../science-and-tech/hard-code.md) regulation sustains the existence of a thriving black market both within districts and across [Greater Atla](greater-atla.md).
...
Credits (CRED), currency symbol "◖" or "C", commonly referred to simply as "creds", are the main medium of exchange across GATA and the native currency of the System.

Introduced with the creation of the System, credits facilitate legal transactions across all sectors, from everyday purchases to large-scale enterprise deals. Credits are intrinsic to the operation of the System, a hard-coded architecture that borrows core principles from [Old World](../../history/the-old-world.md) decentralized networks.

Credits are regularly issued autonomously by [the System](the-system.md) and distributed via [the yield](yield.md) granted to GATA's citizens. The value of CRED is derived from the surplus generated by GATA's extensive operations, natural resources, and energy production, which are sold to domestic and international enterprise, as well as [state partners](../law-and-order/new-dawn-accords.md#signatories).

As these tokens circulate through The System, they gradually accrue in various System-designed token sinks, taking them out of circulation forever. This mechanism ensures that the currency remains stable, valuable, and supports economic growth without the risk of devaluation.

### **Security and Privacy**

Transactions involving CREDS are theoretically untraceable, safeguarding the identities and personal information of users. This feature is particularly important in a world where data breaches are significant concerns. By ensuring that financial transactions cannot be easily tracked, GATA protects its citizens from potential misuse of their financial data.

With that said, this protection comes with a compromise; all CRED transactions are automatically filtered by the hard-coded System [terminals](../../science-and-tech/terminals.md), enforcing all economic policies, preventing illegal transactions, and alerting the local authority to suspicious network activity. Wallets involved in illegal transactions, or holding illegal assets, can be locked by the AIC, preventing the transfer of assets. Even in those cases, the assets can still be used for offline signing, giving them some potential value as slips or paper on the black market.

Of course, these restrictions and censures simply push the black market underground, empowering [syndicates](../criminal-element/syndicates.md) and [local gangs](../criminal-element/gangs.md), boosting [Gray Zone](gray-zones.md) economies, and driving the continued use of alternative currencies, slips, and other forms of physical money. It is also possible for [compromised terminals](../../science-and-tech/terminals.md#terminal-spoofing) and bad actors to undermine the privacy of legal transactions by exploiting transaction data, a breach of WPP law.
...
The financial system of [GATA](../the-basics.md) operates under a robust legal and regulatory framework to ensure its integrity and compliance with the [New Dawn Accords (NDA)](../law-and-order/new-dawn-accords.md) as well as the [Whole Privacy Protection Act (WPP)](../law-and-order/whole-privacy-protection-wpp.md).

When the System or lawmakers wish to incentivize or disincentivize certain kinds of economic activity, such as encouraging overall spending, trade between districts, or reducing the prevalence of certain technologies or environmental impacts, these policies are directly encoded into all legal CRED transactions.

[Atlan Information Control (AIC)](../institutions/atlan-information-control-aic.md) oversees the enforcement of financial regulations, ensuring that all transactions, payment systems, enterprise, enterprise operations, and investment activity aligns with GATA's stringent standards. The WPP further enhances the security of the financial system by regulating data collection, and preventing deceptive practices, surveillance, and systemic abuse.
