...
The local effects felt proximately during thread collapse, even at purportedly ‘safe’ distances, are said to be severely disorienting, with multiple first hand accounts reporting significant distortions in the felt passage of time; namely, an uncanny and uncomfortable experience that subjective time slows to a crawl for minutes or hours uniformly inside of the affected region. This is understood to be the result of an increase in the local irreducibility as multiple timelines recohere by brute force, and more time is compressed into a finite volume of space.

These thread-collapse distortions are categorically different from the “thick-time” effects reported inside [inertial dampener fields](inertial-dampeners.md), or the mild shear artifacts sometimes observed at the edges of high-output [static engines](statics.md#static-engines-and-motion). Static and inertial systems redistribute momentum and acceleration _within a single history_. Thread collapse, by contrast, briefly increases local irreducibility as multiple near-identical timelines recohere by brute force, compressing more causal steps into a finite volume of spacetime.

Due to their intense psychological and cognitive side effects, the intentional use of these time-distortion phenomena in offensive weapons has been proposed by some. Others hypothesize that thread collapse could be causing unseen damage in parallel universes.

Nonetheless, [Angelis](../gata/military-and-defense/angelis.md), with its “special paradigm”, has reportedly begun employing tightly-bounded parallel-energy **distortion charges** as tactical equipment, giving a breaching team or operative a brief window to observe and react with heightened clarity before normal conditions resume.

Illegal **“dilation charges”** and similar time-dilation bombs found in some extreme [sprint gear](gear.md#sprint-gear) loadouts are widely believed to be black-market derivatives of these distortion charges. They are regulated as [Class-1](tech-regulation.md#class-1-red) parallel-energy violations, not as inertial or static technology.
