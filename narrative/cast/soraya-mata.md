...
<figure><img src="../../.gitbook/assets/soraya-splash.png" alt="" width="563"><figcaption><p>Soraya deep in thought in her Nairobi-based lab.</p></figcaption></figure>

## **Bio**

Soraya Mata was born into a turbulent Nairobi in 2061, during a period of political upheaval as political lines were redrawn following the African Union's controversial decision to sign GATA's New Dawn Accords. The resultant riots claimed the lives of her parents, leaving her an orphan at the age of 8. Her father, a community representative, was executed by AFRX separatists, and her mother perished during a terrorist attack known as the Night of Falling Stars.

<figure><img src="../../.gitbook/assets/soraya_feature_young_1109.png" alt="" width="563"><figcaption><p>Soraya, age 7, showed an early aptitude for hard code.</p></figcaption></figure>

Soraya was subsequently placed under state care and, although she was a difficult child with little respect for authority, she quickly demonstrated a prodigious aptitude for technology. At the age of 15, Soraya was offered a position as an exchange student in Atla's High Academy. She had a knack for drawing powerful insights from observing natural systems.

At the age of 17, inspired in part by mycelial networks, Soraya developed an early version of LMNL, the first Asimovian framework capable of compiling directly to NDA-compliant physical functions. LMNL would go on to redefine information safety across GATA. Her studies culminated in the creation of the first LMNL-based filter nodes, marking a significant milestone in the development of secure computational systems, and earned her an enterprise license. But she dreamed of joining the Research Corps and exploring the unknown limits of nature.

Her talents caught the attention of ALTAR, a prestigious Atlan institution, in part thanks to an anonymous recommendation. She was invited to join ALTAR's INSIGHT program where she was grouped with Remi Tranche and Viten Marsh to study Found Objects, mysterious artifacts of unknown origin. The young researchers worked together for years studying numerous objects for ALTAR, sometimes in collaboration with the Research Corps.

After their secretive contracts concluded, the three friends felt they worked well together, despite occasional friction between competing ideals. Together they co-founded Phasia, a joint enterprise pioneering new approaches for securing and scaling various cutting-edge technologies.

With the keys they had acquired through their contract with ALATAR, they had permissions for access and explorative research that meant they could truly push the edge of the possible. However, differing visions for the future of Phasia led to Soraya leaving the highly successful organization, and founding KYO Technologies in Greater Toronto.
...
<figure><img src="../../.gitbook/assets/soraya_HVN_9339_small.png" alt="" width="563"><figcaption><p>Soraya in her lab in the AU working on her replica of the theoretical "Object-X", FO-9.</p></figcaption></figure>
...
* Developed [LMNL](../../world/science-and-tech/hard-code.md#lmnl), a framework for Asimovian systems, at the age of 17.
* Founded KYO Technologies in Nairobi.
* Created Aida, an illegal unfiltered cog based on her own cognitive profile.
* In her later work, stopped writing her hardcode in LMNL, opting for a new framework of her own design despite the necessity for frequent, comprehensive safety testing.
* Referred to by [Viten](viten-marsh.md) and [Remi](remi-maeda.md) as "Sora".
...
* Haunted by the knowledge she gained from her time at [ALTAR](../../world/gata/institutions/altar.md#gatas-innovation-engine).
...
* Mastery of Asimovian architecture and LMNL framework.
